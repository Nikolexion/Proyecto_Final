...
import java.awt.*;
/**
 * Clase que extiende a Habitat, la cual se encarga de la parte logica de habitat Prado, encapsulando su comedero, su imagen
...
public class Prado extends Habitat {
    ...
    public Prado(){
        super(new ImageIcon("resources/Ambientes/Prado.jpg").getImage(), EnumComidas.FRAMBU);
